<cfcomponent output="true">
	...
	<cfscript>
		...
		// objReg = CreateObject("component","cfc.registration");
	...
	<cffunction name="onApplicationStart" returnType="boolean" output="false">
		...
		<cfset Application.DSN 		= "dinky"> 
		
		<cfswitch expression="#CGI.SERVER_NAME#">
			<cfcase value="localhost">
				<cfset Application.Home = "http://127.0.0.1:8501//www.dinkydesigners.com.au">
				<cfset Application.MetroAppID = "1482838855321210">
			</cfcase>
			<cfdefaultcase>
				<cfset Application.Home = "http://www.dinkydesigners.com.au">
